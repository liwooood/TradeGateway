...
PkgHeader::PkgHeader()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:quote.PkgHeader)
}
...
PkgHeader::PkgHeader(const PkgHeader& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:quote.PkgHeader)
}
...
PkgHeader::~PkgHeader() {
  // @@protoc_insertion_point(destructor:quote.PkgHeader)
  SharedDtor();
}
...
const PkgHeader& PkgHeader::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_pkgheader_2eproto();
...
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<PkgHeader*>(16)->f) - \
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:quote.PkgHeader)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:quote.PkgHeader)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:quote.PkgHeader)
  return false;
#undef DO_
}
...
void PkgHeader::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:quote.PkgHeader)
  // required fixed32 bodysize = 1;
  if (has_bodysize()) {
  ...
  // @@protoc_insertion_point(serialize_end:quote.PkgHeader)
}

::google::protobuf::uint8* PkgHeader::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:quote.PkgHeader)
  // required fixed32 bodysize = 1;
  if (has_bodysize()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:quote.PkgHeader)
  return target;
}
